...
const setUpRender = () => {
  ...
  return renderer.create(<Provider store={store}><BrowserRouter><BrandRegistration /></BrowserRouter></Provider>);
};
...
const setUpMount = () => {
  ...
  store = testStore(mockStore);
  return mount(<Provider store={store}><BrowserRouter><BrandRegistration /></BrowserRouter></Provider>);
};
...
describe("BrandRegistration test container", () => {
  let wrapper;
  beforeEach(() => {
  ...
  it("should render the BrandRegistration successfully", () => {
