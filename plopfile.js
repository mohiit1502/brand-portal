module.exports = plop => {
      ...
      actions: [
        {
          ...
          path: "src/client/components/{{pascalCase name}}/{{pascalCase name}}.jsx",
          templateFile:
            "plop-templates/Component/Component.jsx.hbs"
        },
        {
          type: "add",
          path: "src/client/components/{{pascalCase name}}/{{pascalCase name}}.test.js",
          templateFile:
        ...
        },
        {
          type: "add",
          path:
            "src/client/components/{{pascalCase name}}/{{pascalCase name}}.component.scss",
          templateFile:
            "plop-templates/Component/Component.component.scss.hbs"
        },
        {
          type: "add",
          path: "src/client/components/{{pascalCase name}}/index.js",
    ...
    plop.setGenerator("page", {
      ...
      actions: [
        {
          type: "add",
          path: "src/client/pages/{{pascalCase name}}/{{pascalCase name}}.jsx",
          templateFile:
            "plop-templates/Page/Page.jsx.hbs"
        },
        {
          type: "add",
          path: "src/client/pages/{{pascalCase name}}/{{pascalCase name}}.test.js",
          templateFile:
        ...
        },
        {
          type: "add",
          path:
            "src/client/pages/{{pascalCase name}}/{{pascalCase name}}.module.scss",
          templateFile:
            "plop-templates/Page/Page.module.scss.hbs"
        },
        {
          type: "add",
          path: "src/client/pages/{{pascalCase name}}/reducer.js",
          templateFile: "plop-templates/Page/reducer.js.hbs",
          skipIfExists: true
        },
        {
          type: "add",
          path: "src/client/pages/{{pascalCase name}}/selectors.js",
          templateFile: "plop-templates/Page/selectors.js.hbs",
          skipIfExists: true
        },
        {
          type: "add",
          path: "src/client/pages/{{pascalCase name}}/actions.js",
          templateFile: "plop-templates/Page/actions.js.hbs",
          skipIfExists: true
        },
        {
          type: "add",
          path: "src/client/pages/{{pascalCase name}}/index.js",
