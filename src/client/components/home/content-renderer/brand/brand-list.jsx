  ...
  async fetchBrands () {
    ...
    if (response.content && response.content.length) {
      ...
      trademarkList.forEach(brand => {
        if (!brandList[brand.brandId]) {
          brandList[brand.brandId] = [];
          brandList[brand.brandId].push({
        ...
        brandList[brand.brandId].push({brandName: brand.brandName, brandStatus: brand.brandStatus, trademarkStatus: brand.caseStatus, ...brand});
      })
      dissectedBrandList = Object.values(brandList).reduce((acc, arr) => acc.concat(arr), []);
    }
