...
import DemoStates from "./temp-delete-later/demo-states";
import DemoPureStates from "./temp-delete-later/demo-pure-states";
import { DemoButtons } from "./temp-delete-later/demo-buttons";
import DemoDynamicImport from "./temp-delete-later/demo-dynamic-import";
import { Nav } from "./nav";

//
import DemoCookies from "./temp-delete-later/demo-cookies";
//
...
class Hom1Demo extends React.Component {
  constructor(props) {
    super(props);
  }
